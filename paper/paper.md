...
The cloud service provider is thereby delegated the responsibility for the execution of the code.
...
In the event that the free tier is exceeded, AWS Lambda's pricing is very affordable.
